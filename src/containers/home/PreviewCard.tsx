...
const PreviewCard: React.FC<{
  ...
  const {interviewSetting,jobDetail,reqDetails,setInterviewSetting,setJobDetail,setReqDetails} = useData()
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          <DataCard title="Requisition Details">
            <KeyValue
              ...
              value={
                urgencyOptions.find(
                  (item) => item?.value === reqDetails.urgency
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                genderOptions.find(
                  (item) => item?.value === reqDetails.gender
                )?.label
              }
            />
          </DataCard>
          <DataCard title="Job Detail">
            <KeyValue title="Job Title" value={jobDetail.jobTitle} />
            <KeyValue title="Job Details" value={jobDetail.jobDetails} />
            <KeyValue title="Job Location" value={jobDetail.jobLocation} />
          </DataCard>
            ...
            <KeyValue
              ...
              value={
                interviewDurationOptions.find(
                  (item) => item?.value === interviewSetting.interviewDuration
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewLanguageOptions.find(
                  (item) => item?.value === interviewSetting.interviewLanguage
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewModeOptions.find(
                  (item) => item?.value === interviewSetting.interviewMode
                )?.label
              }
            />
          </DataCard>
